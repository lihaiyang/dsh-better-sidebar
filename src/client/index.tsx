...
import {
  attachLocale as attachTelemetryLocale,
  LOCALE_NS as TELEMETRY_LOCALE_NS,
  zh as telemetryZh,
  en as telemetryEn,
} from './telemetry/locales.ts'
...
export function apply(ctx: Context): void {
  ...
  attachTelemetryLocale(ctx.locale)
  ctx.effect(() => {
    const offZh = ctx.locale.register(LOCALE_NS, 'zh', zh)
    const offEn = ctx.locale.register(LOCALE_NS, 'en', en)
    const offTelemetryZh = ctx.locale.register(TELEMETRY_LOCALE_NS, 'zh', telemetryZh)
    const offTelemetryEn = ctx.locale.register(TELEMETRY_LOCALE_NS, 'en', telemetryEn)
    return () => { offZh(); offEn(); offTelemetryZh(); offTelemetryEn() }
