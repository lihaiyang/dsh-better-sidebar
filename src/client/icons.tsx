...
/** Telemetry tab glyph: a small gauge with a needle. */
export const IconTelemetryOutline16 = ({ size = 16, className }: IconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 9.5a6 6 0 0 1 12 0" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    <circle cx="8" cy="9.5" r="1.6" fill="currentColor" stroke="none" />
    <path d="M8 6V4.2M5 3.6 4 2.2M11 3.6l1-1.4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
  </svg>
)
