 ...
 * (explorer / git / terminal / browser / subagent / editor / diff / telemetry) through
...
import { TelemetryTab } from '../telemetry/TelemetryTab.tsx'
import { t as telemetryT } from '../telemetry/locales.ts'
import { IconTerminalOutline16, IconDiffOutline16, IconGlobeOutline16, IconTelemetryOutline16 } from '../icons.tsx'
...
export function builtinTabs(ctx: Context): readonly TabDescriptor[] {
  return [
    ...
    {
      id: 'telemetry',
      title: () => telemetryT('title'),
      icon: (size: number) => <IconTelemetryOutline16 size={size} />,
      order: 35,
      single: true,
      component: ({ ctx, scope, visible }) => (
        <TelemetryTab ctx={ctx} scope={scope} visible={visible} />
      ),
    },
    {
      id: 'terminal',
