...
export const zh = {
  ...
  download: '下载',
  rename: '重命名',
  renameTitle: '重命名文件/文件夹',
  renamePlaceholder: '新名称',
  renameError: '重命名失败',
  delete: '删除',
  deleteTitle: '删除文件/文件夹',
  deleteFileDesc: '将删除文件「{path}」，此操作不可恢复。',
  deleteDirDesc: '将删除文件夹「{path}」及其全部内容，此操作不可恢复。',
  settingsNav: '侧边卡片',
  ...
  fmForward: '前进',
  fmPreview: '预览',
  fmPathPlaceholder: '输入目录路径，回车打开',
  fmName: '名称',
  fmSize: '大小',
  fmMtime: '修改时间',
  fmEmpty: '空目录',
  fmTruncated: '目录项过多，仅显示前 1000 项',
  fmCount: '{count} 项',
  fmSelected: '{path} · {size}',
  fmSelectFile: '选择文件以在此预览',
  fmQuickAccess: '快速访问',
  fmMaximize: '最大化',
  fmRestore: '恢复窗口',
  fmFullPreview: '全屏预览',
  fmExitFullPreview: '退出全屏预览',
  fmFavorite: '收藏当前目录',
  fmUnfavorite: '取消收藏',
  fmFavorites: '收藏夹',
  fmRecent: '最近访问',
  fmNewFolder: '新建文件夹',
  fmNewFolderPlaceholder: '文件夹名称',
  fmNewFilePlaceholder: '文件名称',
  fmInvalidName: '名称不能为空或包含路径分隔符',
  create: '创建',
}
...
export const en: Record<keyof typeof zh, string> = {
  ...
  download: 'Download',
  rename: 'Rename',
  renameTitle: 'Rename file / folder',
  renamePlaceholder: 'New name',
  renameError: 'Rename failed',
  delete: 'Delete',
  deleteTitle: 'Delete file / folder',
  deleteFileDesc: 'Delete file "{path}"? This cannot be undone.',
  deleteDirDesc: 'Delete folder "{path}" and all of its contents? This cannot be undone.',
  ...
  fmForward: 'Forward',
  fmPreview: 'Preview',
  fmPathPlaceholder: 'Enter a directory path and press Enter',
  fmName: 'Name',
  fmSize: 'Size',
  fmMtime: 'Modified',
  fmEmpty: 'Empty directory',
  fmTruncated: 'Directory too large — showing the first 1000 entries',
  fmCount: '{count} items',
  fmSelected: '{path} · {size}',
  fmSelectFile: 'Select a file to preview it here',
  fmQuickAccess: 'Quick access',
  fmMaximize: 'Maximize',
  fmRestore: 'Restore window',
  fmFullPreview: 'Full preview',
  fmExitFullPreview: 'Exit full preview',
  fmFavorite: 'Favorite this folder',
  fmUnfavorite: 'Unfavorite',
  fmFavorites: 'Favorites',
  fmRecent: 'Recent',
  fmNewFolder: 'New folder',
  fmNewFolderPlaceholder: 'Folder name',
  fmNewFilePlaceholder: 'File name',
  fmInvalidName: 'Name cannot be empty or contain path separators',
  create: 'Create',
}
